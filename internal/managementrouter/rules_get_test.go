...
func (s *stubManagementClient) ListRules(ctx context.Context, prOptions management.PrometheusRuleOptions, arOptions management.AlertRuleOptions, pgOptions management.PaginationOptions) (management.ListRulesResult, error) {
