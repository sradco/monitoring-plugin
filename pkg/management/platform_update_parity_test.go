...
func TestPlatformUpdatePreviewExecuteWritableParity(t *testing.T) {
	...
	for _, tc := range fixtures {
		t.Run(tc.name, func(t *testing.T) {
			...
			var arcMutated, arUpdated bool
			wrapMockPersistFlags(mockK8s, &arcMutated, &arUpdated)
...
func wrapMockPersistFlags(mockK8s *testutils.MockClient, arcMutated, arUpdated *bool) {
